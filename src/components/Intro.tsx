        ...
        <Row className='h-100vh section'>
            <Col className='introBanner p-0 bg-primary'>
                <div className='w-25em mx-auto introContent'>
                    ...
                    <Row className='mb-3'>
                        <h1 className='fw-bold display-5 text-center lh-1 m-0 text-stroke'>Vinicius de Castro</h1>
                        <h2 className='text-secondary display-7 text-center lh-1 text-stroke'>Web developer</h2>
                    </Row>
                    <Row>
                        <LangText
